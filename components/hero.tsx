...
const Hero = () => {
  ...
  const textsToType = useMemo(
    () => ["Web Developer", "Full Stack Developer", "Freelancer"],
    []
  );
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center pt-16 lg:pt-20 relative overflow-hidden bg-slate-900"
    >
      {/* Animated Background Elements - Hidden on mobile (screens smaller than lg) for performance */}
        ...
        >
          ...
          <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
            <motion.h1
              ...
              className="text-3xl sm:text-4xl lg:text-6xl font-bold mb-4 lg:mb-6 text-white"
            >
              Hi, I'm <span className="text-purple-500">Mohammed</span>
              <br />
            ...
            <motion.h2
              variants={itemVariants}
              className="text-lg sm:text-xl lg:text-2xl text-slate-300 mb-4 lg:mb-6"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="text-sm sm:text-base lg:text-lg text-slate-400 mb-8 max-w-2xl mx-auto lg:mx-0"
            >
              I blend creativity with technical expertise to build stunning
              websites and innovative AI applications that solve real-world
          ...
          >
            <div className="relative">
              {/* Rotating background glow - Hidden on mobile for performance */}
              <motion.div
                animate={{ rotate: 360 }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                className="absolute inset-0 rounded-full bg-gradient-to-tr from-purple-500/20 to-blue-500/20 hidden lg:block"
              />
              <motion.div
                whileHover={{ scale: 1.05 }}
                transition={{ type: "spring", stiffness: 300 }}
                className="w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-purple-500/30 shadow-2xl relative z-10 bg-slate-800"
              >
                <img
                  src="/profile.png"
