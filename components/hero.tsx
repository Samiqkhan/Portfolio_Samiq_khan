...
const Hero = () => {
    ...
    const textsToType = useMemo(() => ["Web Developer", "Full Stack Developer", "Freelancer"], []);
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
                        ...
                        <motion.h2 variants={itemVariants} className="text-lg sm:text-xl lg:text-2xl text-slate-300 mb-4 lg:mb-6">
                    ...
                    <motion.div variants={imageVariants} className="flex-1 flex justify-center order-1 lg:order-2">
                        <div className="relative">
                            ...
                            >
                                <img
                                    src="images/mohammed-samiq-khan.jpg"
                                    alt="Mohammed Samiq Khan"
                                    className="w-full h-full object-cover"
                                    onError={(e) => { e.currentTarget.src = 'https://placehold.co/400x400/1e293b/94a3b8?text=Profile'; }}
                                />
                            </motion.div>
                        </div>
                    </motion.div>
